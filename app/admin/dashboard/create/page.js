...
export default function CreateBlogPage() {
  ...
  useEffect(() => {
    ...
    fetch('/api/admin/posts?limit=1', { headers: { Authorization: `Bearer ${t}` } })
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-xl border border-white/8 p-4" style={{ background: 'rgba(17,24,39,0.7)' }}>
            ...
            <input
              ...
              className="w-full mt-2 px-3 py-2 text-sm rounded-lg bg-white/5 border border-white/8 text-white placeholder:text-gray-600 focus:outline-none focus:border-emerald-500/40"
            />
          </div>
          ...
          <div className="rounded-xl border border-white/8 p-4" style={{ background: 'rgba(17,24,39,0.7)' }}>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-sm rounded-lg bg-white/5 border border-white/8 text-white placeholder:text-gray-600 focus:outline-none focus:border-emerald-500/40"
            />
          </div>
          ...
          <div className="rounded-xl border border-white/8 p-4" style={{ background: 'rgba(17,24,39,0.7)' }}>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2 text-sm rounded-lg bg-white/5 border border-white/8 text-white placeholder:text-gray-600 focus:outline-none focus:border-emerald-500/40 resize-none"
            />
          </div>
          ...
          <div className="rounded-xl border border-white/8 p-4" style={{ background: 'rgba(17,24,39,0.7)' }}>
            ...
            <select
              ...
              className="w-full mb-3 px-3 py-2 text-sm rounded-lg bg-white/5 border border-white/8 text-white focus:outline-none focus:border-emerald-500/40"
            >
            ...
            <select
              ...
              className="w-full px-3 py-2 text-sm rounded-lg bg-white/5 border border-white/8 text-white focus:outline-none focus:border-emerald-500/40"
            >
            ...
            {tags && (
              <div className="flex flex-wrap gap-1 mt-2">
                {tags.split(',').map((t, i) => t.trim() && (
                  <span key={i} className="px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs">
                    {t.trim()}
                  </span>
                ))}
              </div>
          ...
          <div className="rounded-xl border border-white/8 p-4" style={{ background: 'rgba(17,24,39,0.7)' }}>
            ...
            <input
              ...
              placeholder={`Meta title (default: ${title || 'post title'})`}
              className="w-full mb-3 px-3 py-2 text-sm rounded-lg bg-white/5 border border-white/8 text-white placeholder:text-gray-600 focus:outline-none focus:border-emerald-500/40"
            />
            <textarea
          ...
          <div className="rounded-xl border border-white/8 p-4" style={{ background: 'rgba(17,24,39,0.7)' }}>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-sm rounded-lg bg-white/5 border border-white/8 text-white focus:outline-none focus:border-emerald-500/40"
            />
            <p className="text-xs text-gray-600 mt-1">Leave empty to publish immediately</p>
          </div>
        </div>
      </div>
    </div>
